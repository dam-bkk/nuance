      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10 items-stretch">
          ...
          <div className="flex flex-col gap-3 sm:w-1/3">
            <Link href="#sessions" className="bg-surface rounded-3xl p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-3 flex-1">
            ...
            <Link href="/grammaire" className="bg-surface rounded-3xl p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-3 flex-1">
              <div className="w-9 h-9 rounded-xl bg-cobalt/10 flex items-center justify-center flex-shrink-0">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3B4EF5" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link href="/examens" className="bg-surface rounded-3xl p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-3 flex-1">
              <div className="w-9 h-9 rounded-xl bg-cobalt/10 flex items-center justify-center flex-shrink-0">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3B4EF5" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
